              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className={`w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                    !formVisible ? "bg-slate-50 cursor-not-allowed" : ""
                  }`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={!formVisible ? "bg-slate-50" : ""}
                />
                {errors.address?.wordNo && (
                  <span className="text-red-500 text-sm">
                    {errors.address.wordNo.message}
                  </span>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {errors.education?.level && (
                  <span className="text-red-500 text-sm">
                    {errors.education.level.message}
                  </span>
                )}
              </div>
              <div className="space-y-2">
                <Label
                  htmlFor="education.FOS"
                  className="text-slate-600 text-sm font-medium"
                >
                  Field of Study
                </Label>
                ...
                {errors.education?.FOS && (
                  <span className="text-red-500 text-sm">
                    {errors.education.FOS.message}
                  </span>
                )}
              </div>
            </div>
